...
def main(args):
    ...
    import ray
    ray.init(logging_level=40, local_mode=args.debug, log_to_driver=True)

    towns = {i: f'Town{i+1:02d}' for i in range(7)}
    towns.update({7: 'Town10HD'})
    # towns.update({0:'Town03', 1: 'Town03', 7: 'Town10HD'})
    # towns = {0: 'Town10HD'}
    # towns = {}
    ...
    args.agent = 'team_code/at_collector'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--timeout', default="600000.0",
