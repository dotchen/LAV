...
class CarlaDataProvider(object):  # pylint: disable=too-many-public-methods
    ...
    _ego_vehicle_coarse_route = None
    ...
    @staticmethod
    def set_ego_vehicle_route_waypoint(route):
        CarlaDataProvider._ego_vehicle_route_waypoint = route

    @staticmethod
    def get_ego_vehicle_route_waypoint():
        return CarlaDataProvider._ego_vehicle_route_waypoint
