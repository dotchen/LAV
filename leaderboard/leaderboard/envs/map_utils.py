    ...
    def _render_vehicles(self, surface, list_v, world_to_pixel):
        ...
        for v in list_v:
            ...
            if hasattr(v[0], 'bounding_box'):
                ...
                corners = [carla.Location(x=-bb.x-self.hero_x-4, y=-bb.y-self.hero_y/2-1.),
                          carla.Location(x=-bb.x-self.hero_x-4, y=bb.y+self.hero_y/2+1.),
                          carla.Location(x=bb.x+0.8, y=bb.y+self.hero_y/2+1.),
                          carla.Location(x=bb.x+0.8, y=-bb.y-self.hero_y/2-1.)
                          ]
            else:
                corners = [carla.Location(x=-3.5, y=-0.5),
                          carla.Location(x=-3.5, y=0.5),
                          carla.Location(x=3.5, y=0.5),
                          carla.Location(x=3.5, y=-0.5)
                          ]
